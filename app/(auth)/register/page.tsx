      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          ...
          <h1
            ...
            style={{ fontSize: '1.6rem', color: '#012374', marginBottom: '4px' }}
          >
            Create your account
          </h1>
          <p className="text-sm" style={{ color: 'rgba(1,35,116,0.55)' }}>
            Your caring diabetes companion
          </p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p
                ...
                style={{ color: 'rgba(1,35,116,0.45)' }}
              >
          ...
          <div className="mt-5 text-center">
            <p className="text-sm" style={{ color: 'rgba(1,35,116,0.6)' }}>
              ...
              <Link href="/login" className="font-semibold" style={{ color: '#012374' }}>
                Sign in
              </Link>
            </p>
          </div>
